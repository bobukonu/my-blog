...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        {{ Form::open(['route' => ['blog.update', $post->id], 'method' => 'PUT', 'files' => TRUE, 'id' => 'post-form']) }}
        <div class="col-xs-9">
          <div class="box">
        ...
        <div class="col-xs-3">
          ...
          <div class="box">
            ...
            <div class="box-body text-center">
             ...
             {{ Form::select('category_id', App\Category::pluck('title', 'id'), $post->category->id, ['class' => 'form-control', 'placeholder' => 'Choose Category'])}}
              ...
              <div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
               <div class="fileinput fileinput-new" data-provides="fileinput">
                 <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                   ...
                   @else
                   <img src="/backend/plugins/Jasny/img/noimagefound.png"  alt="...">
                   @endif
                 </div>
                 <div class="fileinput-preview fileinput-exists img-thumbnail" style="max-width: 200px; max-height: 150px;"></div>
                 <div>
                   <span class="btn btn-success btn-file"><span class="fileinput-new">Update image</span><span class="fileinput-exists">Change</span>{{ Form::file('image', null)}}</span>
